...
public class HideHealthBar implements CommandExecutor {
	private final ButtonRebirthPlugin plugin;
	
	public HideHealthBar(ButtonRebirthPlugin initPlugin){
		plugin = initPlugin;
	}
	@Override
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		sender.sendMessage(ChatColor.AQUA + "Health Bar Removed");
