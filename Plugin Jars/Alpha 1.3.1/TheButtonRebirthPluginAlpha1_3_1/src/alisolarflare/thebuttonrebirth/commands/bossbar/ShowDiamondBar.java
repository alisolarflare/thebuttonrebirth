...
public class ShowDiamondBar implements CommandExecutor {
	private final ButtonRebirthPlugin plugin;
	
	public ShowDiamondBar(ButtonRebirthPlugin initPlugin){
		plugin = initPlugin;
	}
	@Override
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		sender.sendMessage(ChatColor.AQUA + "Diamond Bars Displayed");
